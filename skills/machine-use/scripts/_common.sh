#!/usr/bin/env bash
# _common.sh — shared helpers for the machine-use skill.
# A duplicated copy of the same helpers lives in ../machine-setup/scripts/_common.sh;
